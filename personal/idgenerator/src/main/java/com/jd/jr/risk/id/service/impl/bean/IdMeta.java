package com.jd.jr.risk.id.service.impl.bean;
...
public class IdMeta {
    ...
    public long getTimeBitsStartPos() {
        return (long)machineBits + seqBits;
    }
    ...
    public long getGenMethodBitsStartPos() {
        return (long)machineBits + seqBits + timeBits;
    }
    ...
    public long getTypeBitsStartPos() {
        return (long)machineBits + seqBits + timeBits + genMethodBits;
    }
    ...
    public long getVersionBitsStartPos() {
        return (long)machineBits + seqBits + timeBits + genMethodBits + typeBits;
    }
